    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
      <div className="bg-white rounded-3xl shadow-lg p-8 w-full max-w-md">
        ...
        <button
          ...
          className="w-full border-2 border-gray-200 rounded-xl py-3 flex items-center justify-center gap-3 font-semibold text-gray-700 hover:border-gray-300 transition-colors mb-4"
        >
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-[#1a1a1a] text-white py-3 rounded-xl font-bold hover:opacity-80 transition-opacity disabled:opacity-40"
          >
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          ...
          <Link href="/auth/inscription" className="text-[#8ab5a7] font-semibold hover:underline">S&apos;inscrire</Link>
        </p>
      </div>
    </div>
  )
